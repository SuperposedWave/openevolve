...
def build_markdown(rows: list[dict]) -> str:
    ...
    lines = [
        ...
        "## Experiment Setup",
        "",
        "- Search task: construct ternary `GF(3)` systematic parity-check matrices of the form `H = [P^T | I_r]`.",
        "- Priority source: OpenEvolve evolves a static `priority(column_code, n, k, d)` heuristic.",
