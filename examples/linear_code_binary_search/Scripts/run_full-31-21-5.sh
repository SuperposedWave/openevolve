...
LINEAR_CODE_N="${LINEAR_CODE_N:-31}"
LINEAR_CODE_K="${LINEAR_CODE_K:-17}"
LINEAR_CODE_D="${LINEAR_CODE_D:-7}"
...
LINEAR_CODE_REPAIR_DROP_COUNT="${LINEAR_CODE_REPAIR_DROP_COUNT:-3}"
...
CONFIG_TEMPLATE="${CONFIG_TEMPLATE:-examples/linear_code_binary_search/Configs/config_c_kernel_large.yaml}"
...
RUN_RECORD_DIR="${RUN_RECORD_DIR:-full_${RUN_TAG}}"
